...
from ...utils import rq_json as json_utils
from .utils import get_realtime_quotes, order_book_id_2_tushare_code, is_holiday_today, is_tradetime_now, get_tick
        ...
        while True:
            if not is_holiday_today() and is_tradetime_now():
                ...
                try:
                    ...
                    system_log.exception("get_realtime_tick fail")
                    continue
                try:
